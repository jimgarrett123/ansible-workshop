...
==== *+++<u>TASK 1.</u>+++* 
On your control node, change to the directory */home/studentnn/lightbulb/workshops/ansbile_engine/basic_playbook/resources* (please note you will need to specify the correct user under the home directory)
